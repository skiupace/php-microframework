      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <a
              href="/"
              class="<?= Validator::isUrl('/') ? "bg-gray-900 text-white" :
                        "text-gray-300 hover:bg-gray-700 hover:text-white"; ?>
                          rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</a>
            <a
              href="/about"
              class="<?= Validator::isUrl('/about') ? "bg-gray-900 text-white" :
                        "text-gray-300 hover:bg-gray-700 hover:text-white"; ?>
            ...
            <?php if ($_SESSION['user'] ?? false): ?>
              <a
                href="/notes"
                class="<?= Validator::isUrl('/notes') ? "bg-gray-900 text-white" :
                          "text-gray-300 hover:bg-gray-700 hover:text-white"; ?>
            ...
            <a
              href="/contact"
              class="<?= Validator::isUrl('/contact') ? "bg-gray-900 text-white" :
                        "text-gray-300 hover:bg-gray-700 hover:text-white"; ?>
          ...
          <div class="relative ml-3">
            <div>
              ...
              <?php else: ?>
                <a
                  href="/register"
                  class="<?= Validator::isUrl('/register') ? "bg-gray-900 text-white" :
                        "text-gray-300 hover:bg-gray-700 hover:text-white"; ?>
                          rounded-md px-3 py-2 text-sm font-medium">Register</a>
                <a
                  href="/login"
                  class="<?= Validator::isUrl('/login') ? "bg-gray-900 text-white" :
                        "text-gray-300 hover:bg-gray-700 hover:text-white"; ?>
    ...
    <div class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        ...
        <a
          ...
          class="<?= Validator::isUrl('/') ? "bg-gray-900 text-white" :
                    "text-gray-300 hover:bg-gray-700 hover:text-white"; ?>
                    block rounded-md px-3 py-2 text-base font-medium text-white" aria-current="page">Home</a>
        <a
          href="/about.php"
          class="<?= Validator::isUrl('/about.php') ? "bg-gray-900 text-white" :
                    "text-gray-300 hover:bg-gray-700 hover:text-white"; ?>
                    block rounded-md px-3 py-2 text-base font-medium">About</a>
        <a
          href="/contact.php"
          class="<?= Validator::isUrl('/contact.php') ? "bg-gray-900 text-white" :
                    "text-gray-300 hover:bg-gray-700 hover:text-white"; ?>
